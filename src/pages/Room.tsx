        ...
        {!extractYouTubeId(videoUrl) ? (
          ...
          <YouTube
            ...
            opts={{
              ...
              playerVars: {
                playsinline: 1,
                controls: 1,   // wajib tampil untuk semua user (YouTube ToS)
                disablekb: 1,  // keyboard tetap disabled semua agar non-host tidak bisa kontrol
                rel: 0,
          ...
          <div className="flex flex-col p-3 md:p-5 gap-4 shrink-0 transition-all z-20 md:border-none border-t border-white/5">
            <div className="bg-[#161c2d] border border-[#2e3c5a] shadow-lg rounded-[24px] p-4 flex flex-col gap-4">
              <div className="flex flex-row gap-3 items-center w-full">
                ...
                {isHost && (
                  <p className="text-[9px] text-slate-600 text-center w-full -mt-2 px-1">
                    Pastikan kamu memiliki hak atas video yang diupload
                  </p>
                )}
